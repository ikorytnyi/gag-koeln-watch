...
- **Розклад**: щодня о 8:00, 10:00, 12:00, 15:00 (Europe/Berlin). Розклад
  зберігається як "сирий" cron прив'язаний до конкретної години — під час
  переходу CET↔CEST (кінець березня / кінець жовтня) реальний локальний час
  запуску може зміститись на годину, поки розклад не поправлять вручну.
